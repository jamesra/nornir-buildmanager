...
class TestShared(unittest.TestCase):
    ...
    def testName(self):
        ...
        FilenameParserTestCase = collections.namedtuple('FilenameParserTestCase',
                                                        'string Number Version Name Downsample Extension')
        ...
        test_cases = [
            ...
            FilenameParserTestCase("20 B This is a long description 32.idoc", 20, 'B', "This is a long description", 32,
                                   '.idoc'),
            ...
            FilenameParserTestCase("31 B_NameHere", 31, 'B', 'NameHere', None, None),
            # Two digit section number with a letter
            FilenameParserTestCase("32_B_NameHere", 32, 'B', 'NameHere', None, None),
            # Two digit section number with a letter
            FilenameParserTestCase("33_B_NameHere.idoc", 33, 'B', 'NameHere', None, '.idoc'),
            # Two digit section number with a letter
            FilenameParserTestCase("34_B_NameHere.idoc", 34, 'B', 'NameHere', None, '.idoc'),
            # Two digit section number with a letter
        ]
