...
#    def runTest(self):
#
#        buildArgs = ['Build.py','-input', self.PlatformFullPath,'-volume',self.VolumeFullPath, '-debug'];
#        Build.Execute(buildArgs);
#
#        self.LoadMetaData()
#
#        SectionNodes = list(self.VolumeObj.findall("Block/Section"));
#        self.assertEqual(len(SectionNodes),4);
#
