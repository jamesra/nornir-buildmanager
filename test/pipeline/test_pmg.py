...
class PMGBuildTest(PMGTest):
    ...
    def runTest(self):
        ...
        self.RunExportImages(Channels="(!Registered)", Filters="Leveled", AssembleLevel=1, Output=os.path.join(self.TestOutputPath, "Mosaics"))
        ...
        self.RunExportImages(Channels="Registered", Filters="ShadingCorrected", AssembleLevel=1, Output=os.path.join(self.TestOutputPath, "Registered"))
