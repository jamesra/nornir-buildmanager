...
if __name__ == '__main__':
    ...
    install_requires = ["nornir_pools>=1.1.3",
                        "nornir_shared>=1.1.2",
                        "nornir_imageregistration>=1.1.3",
                        "numpy>=1.8.0",
                        "scipy>=0.13.2",
                        "matplotlib"]
    ...
    dependency_links = ["git+http://github.com/nornir/nornir-pools#egg=nornir_pools-1.1.3",
                        "git+http://github.com/nornir/nornir-shared#egg=nornir_shared-1.1.2",
                        "git+http://github.com/nornir/nornir-imageregistration#egg=nornir_imageregistration-1.1.3"]
