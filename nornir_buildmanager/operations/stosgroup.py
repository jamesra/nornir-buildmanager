...
def ListGroupSectionMappings(BlockNode, GroupName, Downsample, **kwargs):
    ...
    print("{0:s}{1:s}{2:s}{3:s}{4:s}{5:s}".format('Section'.ljust(10), 'Channel'.ljust(10), 'Filter'.ljust(10),
...
def ImportStos(InputStosFullpath, BlockNode, GroupName,
    ...
    ControlFilter = BlockNode.GetSection(ControlSectionNumber).GetChannel(ControlChannelName).GetFilter(
        ControlFilterName)
