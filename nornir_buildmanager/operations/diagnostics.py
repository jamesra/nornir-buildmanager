...
def PlotMosaicOverlaps(TransformNode, OutputFilename, Downsample=None, InputFilterName=None, ShowFeatureScores=False, **kwargs):
    ...
    mosaic_tileset = nornir_imageregistration.mosaic_tileset.CreateFromMosaic(mosaic, image_folder=LevelNode.FullPath, image_to_source_space_scale=LevelNode.Downsample)
    
    (distinct_overlaps, new_overlaps, updated_overlaps, removed_overlap_IDs, non_overlapping_IDs) = nornir_imageregistration.arrange_mosaic.GenerateTileOverlaps(mosaic_tileset,
