...
nornir-build Histogram -volume %1  -InputFilter ShadingCorrected -InputTransform Prune -Downsample 2 
nornir-build AdjustContrast -volume %1  -InputFilter ShadingCorrected -OutputFilter LeveledShadingCorrected -InputTransform Prune Leveled -Gamma 1
...
nornir-build Assemble -volume %1  -Filter ShadingCorrected -Downsample 1 -NoInterlace -Transform Grid
nornir-build ExportImages -volume %1  -Filters ShadingCorrected -Downsample 1 -Output %1_Mosaic
nornir-build MosaicReport -volume %1  -PruneFilter ShadingCorrected -ContrastFilter ShadingCorrected -AssembleFilter ShadingCorrected -AssembleDownsample 1