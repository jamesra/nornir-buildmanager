...
nornir-build %1 ScaleVolumeTransforms -InputGroup CMP -InputDownsample 8 -OutputDownsample 1

title Merge CMP transforms into TEM transforms 
nornir-build %1 CopyStosGroup -Input CMP -Output Grid -Downsample 1
